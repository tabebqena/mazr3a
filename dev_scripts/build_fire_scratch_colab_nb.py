...
C_CONFIG = code([
    ...
    "    # Downloaded via Kaggle's PUBLIC dataset-zip API (same endpoint kagglehub uses), so no\n",
    "    # kagglehub dependency is needed. role='train' maps D-Fire train->train, val->val,\n",
    "    # test->test (the test split stays held out).\n",
    "    {'id': 'dfire', 'type': 'zip_url',\n",
    "     'url': 'https://www.kaggle.com/api/v1/datasets/download/sayedgamal99/smoke-fire-detection-yolo',\n",
    "     'download': 'wget', 'layout': 'roboflow',\n",
