...
dev_scripts/fire/prep_fire_large_dataset.py (<out>_colab.zip).
...
Usage:
    python dev_scripts/colab/build_fire_large_colab_nb.py
        # writes notebooks/fire-large-finetune-colab.ipynb
    python dev_scripts/colab/build_fire_large_colab_nb.py --out <dir>/fire-large-finetune-colab.ipynb
...
C_TITLE = md(
    [
        ...
        "on the dataset zip built by `dev_scripts/fire/prep_fire_large_dataset.py`.\n",
        "\n",
        ...
        "  `python dev_scripts/fire/prep_fire_large_dataset.py --ready model-training/sources/ready_fire_smoke.yolov8 "
