...
-------------------------------------
  ...
  * training is launched DETACHED (subprocess.Popen(start_new_session=True) -> the bundled
    dev_scripts/colab/colab_train_scratch.py), so closing VS Code / the tab cannot stop it;
...
Usage:
    python dev_scripts/colab/build_fire_scratch_colab_nb.py
        # writes model-training/scratch-model/scratch-v3/fire-scratch-train-colab.ipynb
    python dev_scripts/colab/build_fire_scratch_colab_nb.py --out <dir>/fire-scratch-train-colab.ipynb
"""
import argparse
import json
import os
