...
#
# Usage:
#   ./dev_scripts/colab/pack_colab_upload.sh [output.zip]
...
cp dev_scripts/fire/prep_fireviewer_dataset.py dev_scripts/colab/colab_train_v6.py "$WORK/scripts/"
...
echo
echo "Upload that one file to Google Drive:  MyDrive/colab-data/v6-training/"
echo "then run the Colab notebook generated by dev_scripts/colab/build_colab_fireviewer_nb.py"
