...
#
# Usage:
#   ./dev_scripts/colab/pack_fire_scratch_colab.sh [--out DIR] [--version v3] [--negatives true|false]
set -euo pipefail

ROOT="$(cd "$(dirname "$0")/../.." && pwd)"
cd "$ROOT"
MT="model-training"
OUT_DIR="$MT/scratch-model/scratch-v3"
VERSION="v3"
NEGATIVES=true
while [ $# -gt 0 ]; do
  case "$1" in
...
cp dev_scripts/fire/prep_fire_scratch_dataset.py \
   dev_scripts/fire/prep_fireviewer_dataset.py \
   dev_scripts/fire/dedup_fire_scratch.py \
   dev_scripts/fire/augment_fire_train.py \
   dev_scripts/colab/colab_train_scratch.py "$WORK/scripts/"
...
echo "then run the notebook generated by dev_scripts/colab/build_fire_scratch_colab_nb.py"
