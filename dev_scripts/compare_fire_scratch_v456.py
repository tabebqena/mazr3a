...
Usage:
    .venv/bin/python dev_scripts/compare_fire_scratch_v456.py \
...
sys.path.insert(0, os.path.join(ROOT, "dev_scripts"))
...
def main():
    ...
    L.append("**Generated:** %s · **manifest:** `%s` (%d imgs) · **headline conf:** %.2f · "
             "**harness:** `dev_scripts/compare_fire_scratch_v456.py`\n"
