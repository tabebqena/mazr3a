...
#
# Usage:
#   ./dev_scripts/deploy/prep_fire_model.sh /path/to/best.pt [imgsz] [classes]
# Examples:
#   ./dev_scripts/deploy/prep_fire_model.sh ~/Downloads/best.pt 640 "fire,smoke"
#   ./dev_scripts/deploy/prep_fire_model.sh ~/Downloads/best.pt 640 "fire"     # fire-only model
#
