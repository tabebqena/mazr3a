...
# fetched by dev_scripts/deploy/prep_scene_model_llamacpp.sh and run by llama.cpp; this
...
#
# Usage:
#   ./dev_scripts/deploy/prep_scene_model.sh              # default: Qwen2-VL-2B int4 (~1.76 GB)
#   ./dev_scripts/deploy/prep_scene_model.sh --list       # show the curated repos
#   ./dev_scripts/deploy/prep_scene_model.sh --repo 2b25  # Qwen2.5-VL-3B int4 (~2.5 GB)
#   ./dev_scripts/deploy/prep_scene_model.sh --repo <user/model>   # any pre-converted OV VLM repo
#   ./dev_scripts/deploy/prep_scene_model.sh --export --model <hf-id>   # BUILD locally instead
