...
# (the old dev_scripts/deploy/prep_scene_model.sh needed curl+python3 and this keeps
# that promise).
#
# WHAT IT FETCHES
...
#   bash dev_scripts/deploy/prep_scene_model_llamacpp.sh --list       # show the repo files
#   bash dev_scripts/deploy/prep_scene_model_llamacpp.sh --force      # re-download
#   bash dev_scripts/deploy/prep_scene_model_llamacpp.sh --bin        # ALSO fetch llama.cpp
#   bash dev_scripts/deploy/prep_scene_model_llamacpp.sh --repo USER/MODEL
#   bash dev_scripts/deploy/prep_scene_model_llamacpp.sh --bin --llamacpp-tag b10900
