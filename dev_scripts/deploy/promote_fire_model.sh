...
#
# Usage:
#   ./dev_scripts/deploy/promote_fire_model.sh <version-dir|unique-prefix>
# Examples:
#   ./dev_scripts/deploy/promote_fire_model.sh v2-2026-09-05-hf-abonia877-ft5ep
#   ./dev_scripts/deploy/promote_fire_model.sh v2            # unique-prefix match
#
...
if [ "$IR_READY" -eq 1 ]; then
  ...
  echo "     ./dev_scripts/deploy/prep_fire_model.sh models/fire/best.pt 640 \"fire,other,smoke\""
fi
...
echo "       docker compose exec firewatch python /firewatch/firewatch.py --check"
