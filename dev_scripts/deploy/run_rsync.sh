...
#
# Usage:
#   DEPLOY_SSH_USER=ai DEPLOY_SSH_PASS='...' dev_scripts/deploy/run_rsync.sh <src> <dst> [rsync args...]
#
# Examples:
#   # pull the staged clip export to the local mirror (resumable)
#   DEPLOY_SSH_USER=ai DEPLOY_SSH_PASS='...' \
#     dev_scripts/deploy/run_rsync.sh ai@ssh.mazr3a.garden:/home/dr/frigate/cam-clips/ ./camera-clips/
#
