#!/usr/bin/env python3
"""Copy train images that have no label (missing or empty .txt) to model-training/unlabelled-images-dir."""
import shutil
from pathlib import Path

BASE = Path("model-training/sources/ready_fire_smoke.yolov8/train")
IMAGES = BASE / "images"
LABELS = BASE / "labels"
DEST = Path("model-training/unlabelled-images-dir")
