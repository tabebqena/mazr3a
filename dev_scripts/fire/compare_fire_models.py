...
canonical scorer `dev_scripts/fire/test_fire_model.py` (the exact harness that produced
...
Usage:
    .venv/bin/python dev_scripts/fire/compare_fire_models.py \
    ...
    .venv/bin/python dev_scripts/fire/compare_fire_models.py --list-models
    .venv/bin/python dev_scripts/fire/compare_fire_models.py --list-suites
...
def build_report(cells, models, suites, args, run_dir):
    ...
    L.append(f"**Generated:** {now}  ·  **conf:** {args.conf}  ·  **imgsz:** {args.imgsz}  ·  "
             f"**harness:** `dev_scripts/fire/test_fire_model.py` (identical for every cell)\n")
