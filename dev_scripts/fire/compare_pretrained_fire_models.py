...
Usage:
    .venv/bin/python dev_scripts/fire/compare_pretrained_fire_models.py \
    ...
    .venv/bin/python dev_scripts/fire/compare_pretrained_fire_models.py --list-models
...
def main():
    ...
    L.append("**Generated:** %s · **manifest:** `%s` (%d imgs) · **headline conf:** %.2f · "
             "**harness:** `dev_scripts/fire/compare_pretrained_fire_models.py`\n"
