...
Reads the merged pool written by dev_scripts/fire/prep_fire_scratch_dataset.py
...
small pure-Python "dirty tail", exactly like dev_scripts/fire/dedup_images.py. Nothing is ever
