...
-----
    ...
    .venv/bin/python dev_scripts/fire/prep_fireviewer_dataset.py --out $FV/fireviewer_v1_yolo --zip
    ...
    .venv/bin/python dev_scripts/fire/prep_fireviewer_dataset.py \
...
def write_data_yaml(out, splits, sources=None, limit=0, seed=0, sample_mode="group"):
    ...
    with open(path, "w", encoding="utf-8") as fh:
        ...
        fh.write("# generated by dev_scripts/fire/prep_fireviewer_dataset.py\n")
        if sources:
...
def main():
    ...
    rep.append("HELD OUT: the 'test' split must NOT be trained on. A bounded 1,000-image "
               ...
               "dev_scripts/fire/compare_fire_models.py (model-training/eval/fireviewer_test_sample).")
    text = "\n".join(rep)
