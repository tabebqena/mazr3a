...
Usage:
    ...
    .venv/bin/python dev_scripts/fire/score_fire_images.py <dir> [<dir2> ...] --per-dir 15

    # every image under every root (skip any 'test' dirs automatically)
    .venv/bin/python dev_scripts/fire/score_fire_images.py <dir> --per-dir 0 --sample 0

    # more skips + copy everything scoring >= 0.35 for a look
    .venv/bin/python dev_scripts/fire/score_fire_images.py "model-training/to extract" \
