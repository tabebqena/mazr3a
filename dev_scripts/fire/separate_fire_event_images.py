...
The camera-clip export ([`dev_scripts/fire/export_camera_clips.py`](export_camera_clips.py))
...
Usage:
    .venv/bin/python dev_scripts/fire/separate_fire_event_images.py
    .venv/bin/python dev_scripts/fire/separate_fire_event_images.py --min-score 0.7
    .venv/bin/python dev_scripts/fire/separate_fire_event_images.py --label any
    .venv/bin/python dev_scripts/fire/separate_fire_event_images.py \
