...
#
# Usage:
#   sudo ./dev_scripts/install_log_listener.sh            # install + start
#   sudo ./dev_scripts/install_log_listener.sh --remove   # stop + uninstall
#
# After install:
...
LISTENER="$REPO_DIR/dev_scripts/port_listener.py"
